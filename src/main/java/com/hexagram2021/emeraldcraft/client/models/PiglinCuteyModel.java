...
public class PiglinCuteyModel<T extends PiglinCuteyEntity> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		root.addOrReplaceChild("body", CubeListBuilder.create()
				.texOffs(16, 16).addBox(-4.0F, 1.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(16, 32).addBox(-4.0F, 1.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition headDef = root.addOrReplaceChild("head", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-5.0F, -7.0F, -4.0F, 10.0F, 8.0F, 8.0F, new CubeDeformation(0.24F))
		...
		headDef.addOrReplaceChild(
				"left_ear",
				CubeListBuilder.create()
						.texOffs(51, 6).addBox(-0.5F, 1.0F, -2.0F, 1.0F, 5.0F, 4.0F,
		...
		headDef.addOrReplaceChild(
				"right_ear",
				CubeListBuilder.create()
						.texOffs(39, 6).addBox(-0.5F, 1.0F, -2.0F, 1.0F, 5.0F, 4.0F,
				new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, -6.0F, 0.0F, 0.0F, 0.0F, 0.3491F)
		);
		root.addOrReplaceChild(
				"left_arm", CubeListBuilder.create()
						.texOffs(34, 48).addBox(-1.0F, -1.0F, -2.0F, 3.0F, 10.0F, 3.0F,
								new CubeDeformation(0.0F)),
		...
		root.addOrReplaceChild(
				"right_arm",
				CubeListBuilder.create()
						.texOffs(42, 16).addBox(-2.0F, -1.0F, -2.0F, 3.0F, 10.0F, 3.0F,
				new CubeDeformation(0.0F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F)
		);
		root.addOrReplaceChild(
				"left_leg",
				CubeListBuilder.create()
						.texOffs(18, 48).addBox(-1.4F, 1.0F, -2.0F, 3.0F, 11.0F, 3.0F,
				new CubeDeformation(0.0F)),
		...
		root.addOrReplaceChild(
				"right_leg",
				CubeListBuilder.create()
						.texOffs(2, 16).addBox(-1.6F, 1.0F, -2.0F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.9F, 11.0F, 0.0F)
		);
