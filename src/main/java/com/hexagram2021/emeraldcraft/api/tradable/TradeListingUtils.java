...
public interface TradeListingUtils {
    ...
    record TradeListing(Int2ObjectMap<VillagerTrades.ItemListing[]> listings,
                        EntityType<? extends LivingEntity> entityType, @Nullable VillagerProfession profession) {
    }
}
