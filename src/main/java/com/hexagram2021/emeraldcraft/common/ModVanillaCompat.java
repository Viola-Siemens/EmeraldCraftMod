...
public class ModVanillaCompat {
    public static void setup() {
        //STRIPPABLES
        registerStripped(ECBlocks.Plant.GINKGO_LOG.get(), ECBlocks.Plant.STRIPPED_GINKGO_LOG.get());
        registerStripped(ECBlocks.Plant.GINKGO_WOOD.get(), ECBlocks.Plant.STRIPPED_GINKGO_WOOD.get());
        registerStripped(ECBlocks.Plant.PALM_LOG.get(), ECBlocks.Plant.STRIPPED_PALM_LOG.get());
        registerStripped(ECBlocks.Plant.PALM_WOOD.get(), ECBlocks.Plant.STRIPPED_PALM_WOOD.get());
        registerStripped(ECBlocks.Plant.PEACH_LOG.get(), ECBlocks.Plant.STRIPPED_PEACH_LOG.get());
        registerStripped(ECBlocks.Plant.PEACH_WOOD.get(), ECBlocks.Plant.STRIPPED_PEACH_WOOD.get());
        registerStripped(ECBlocks.Plant.PURPURACEUS_STEM.get(), ECBlocks.Plant.STRIPPED_PURPURACEUS_STEM.get());
        registerStripped(ECBlocks.Plant.PURPURACEUS_HYPHAE.get(), ECBlocks.Plant.STRIPPED_PURPURACEUS_HYPHAE.get());
...
/*        registerFlowerPot(ECBlocks.Plant.CYAN_PETUNIA.get(), ECBlocks.Plant.POTTED_CYAN_PETUNIA::get);
    ...
    private static void registerStripped(Block input, Block stripped) {
    ...
    public static void registerFlammable(Block blockIn, int burn, int spread) {
        flammableRegistry.add(blockIn, burn, spread);
    }
