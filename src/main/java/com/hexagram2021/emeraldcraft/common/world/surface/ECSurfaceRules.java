...
public class ECSurfaceRules {
	...
	private static final SurfaceRules.RuleSource PURPURACEUS_NYLIUM = makeStateRule(ECBlocks.Plant.PURPURACEUS_NYLIUM.get());
	private static final SurfaceRules.RuleSource PURPURACEUS_WART_BLOCK = makeStateRule(ECBlocks.Plant.PURPURACEUS_WART_BLOCK.get());
		...
		SurfaceRules.RuleSource hillAndSeaAndDesertSource = SurfaceRules.sequence(
				...
				SurfaceRules.ifTrue(
						...
						SurfaceRules.sequence(
								...
								SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.SURFACE, 0.45D, 0.6D), COARSE_DIRT),
								sandstoneLinedSand
						)
				),
				SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.DRIPSTONE_CAVES), STONE)
												...
												SurfaceRules.ifTrue(
														...
														SurfaceRules.sequence(
																SurfaceRules.ifTrue(
																		wartBlockNoised,
																		SurfaceRules.sequence(
																				SurfaceRules.ifTrue(netherStoneNoised, LAVA),
