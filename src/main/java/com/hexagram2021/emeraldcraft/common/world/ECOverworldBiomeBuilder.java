...
public class ECOverworldBiomeBuilder {
	...
	public ECOverworldBiomeBuilder(Climate.Parameter uniqueness) {
	...
	protected void addPeaks(Registry<Biome> biomeRegistry, Consumer<Pair<TBClimate.ParameterPoint, ResourceKey<Biome>>> mapper, Climate.Parameter weirdness) {
		for(int i = 0; i < TEMPERATURES.length; ++i) {
			Climate.Parameter temperature = TEMPERATURES[i].parameter();
	...
	protected void addHighSlice(Registry<Biome> biomeRegistry, Consumer<Pair<TBClimate.ParameterPoint, ResourceKey<Biome>>> mapper, Climate.Parameter weirdness) {
		for(int i = 0; i < TEMPERATURES.length; ++i) {
			Climate.Parameter temperature = TEMPERATURES[i].parameter();
	...
	protected void addMidSlice(Registry<Biome> biomeRegistry, Consumer<Pair<TBClimate.ParameterPoint, ResourceKey<Biome>>> mapper, Climate.Parameter weirdness) {
		this.addSurfaceBiome(mapper,
	...
	protected void addLowSlice(Registry<Biome> biomeRegistry, Consumer<Pair<TBClimate.ParameterPoint, ResourceKey<Biome>>> mapper, Climate.Parameter weirdness) {
		this.addSurfaceBiome(mapper,
				ParameterUtils.Temperature.FULL_RANGE.parameter(),
				ParameterUtils.Humidity.FULL_RANGE.parameter(),
				ParameterUtils.Continentalness.COAST.parameter(),
	...
	protected void addValleys(Registry<Biome> biomeRegistry, Consumer<Pair<TBClimate.ParameterPoint, ResourceKey<Biome>>> mapper, Climate.Parameter weirdness) {
		this.addSurfaceBiome(mapper,
	...
	protected void addUndergroundBiomes(Registry<Biome> biomeRegistry, Consumer<Pair<TBClimate.ParameterPoint, ResourceKey<Biome>>> mapper) {
