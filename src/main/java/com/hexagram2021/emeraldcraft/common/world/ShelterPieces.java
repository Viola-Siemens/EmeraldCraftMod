...
public class ShelterPieces {
	...
	public static class ShelterPiece extends TemplateStructurePiece {
		...
		public ShelterPiece(ServerLevel level, CompoundTag tag) {
			super(ECStructures.SHELTER_TYPE, tag, level, (location) -> makeSettings(Rotation.valueOf(tag.getString("Rot"))));
		}
