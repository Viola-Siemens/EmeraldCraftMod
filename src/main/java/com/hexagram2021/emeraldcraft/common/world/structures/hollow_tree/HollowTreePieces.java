...
public class HollowTreePieces {
	...
	public static class HollowTreePiece extends TemplateStructurePiece {
		public HollowTreePiece(StructureManager structureManager, ResourceLocation location, BlockPos pos, Rotation rotation) {
		...
		public HollowTreePiece(StructurePieceSerializationContext context, CompoundTag tag) {
			super(ECStructurePieceTypes.HOLLOW_TREE_TYPE, tag, context.structureManager(), (location) -> makeSettings(Rotation.valueOf(tag.getString("Rot"))));
		}
