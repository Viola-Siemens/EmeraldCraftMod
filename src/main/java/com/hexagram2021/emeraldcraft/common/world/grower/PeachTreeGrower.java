...
public class PeachTreeGrower extends Tree {
	@Override
	protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getConfiguredFeature(Random random, boolean bee) {
		switch (random.nextInt(3)) {
			case 0:
				return ECConfiguredFeatures.TreeConfiguredFeatures.PEACH_1;
			case 1:
				return ECConfiguredFeatures.TreeConfiguredFeatures.PEACH_2;
			case 2:
				return ECConfiguredFeatures.TreeConfiguredFeatures.PEACH_3;
			default:
