	...
	public static class Events {
		...
		public static void registerTrades(VillagerTradesEvent event) {
			...
			if(CARPENTER.equals(event.getType().getRegistryName())) {
				...
				trades.get(5).add(new ECTrades.EmeraldForItems(Items.AMETHYST_BLOCK, 4, 1, ECTrades.COMMON_ITEMS_SUPPLY, ECTrades.XP_LEVEL_5_TRADE));
				...
				trades.get(1).add(new ECTrades.ItemsForEmeralds(new ItemStack(ECItems.MELTED_EMERALD_BUCKET), 10, 1, ECTrades.UNCOMMON_ITEMS_SUPPLY, ECTrades.XP_LEVEL_1_SELL));
