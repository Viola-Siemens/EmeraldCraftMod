...
public class PiglinCuteyData {
	...
	public PiglinCuteyData setLevel(int newLevel) { return new PiglinCuteyData(newLevel); }
	...
	public static boolean canLevelUp(int level) { return level >= MIN_LEVEL && level < MAX_LEVEL; }
}
