...
public class NetherPigmanEntity extends AbstractVillagerEntity {
	...
	public NetherPigmanEntity(EntityType<? extends NetherPigmanEntity> entityType, World level) {
	...
	protected void updateTrades() {
		VillagerTrades.ITrade[] list1 = ECTrades.NETHER_PIGMAN_TRADES.get(1);
		VillagerTrades.ITrade[] list2 = ECTrades.NETHER_PIGMAN_TRADES.get(2);
		VillagerTrades.ITrade[] list3 = ECTrades.NETHER_PIGMAN_TRADES.get(3);
