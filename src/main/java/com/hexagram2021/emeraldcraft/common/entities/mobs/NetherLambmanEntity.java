...
public class NetherLambmanEntity extends AbstractVillager {
	...
	public NetherLambmanEntity(EntityType<? extends NetherLambmanEntity> entityType, Level level) {
	...
	protected void updateTrades() {
		VillagerTrades.ItemListing[] list1 = ECTrades.NETHER_LAMBMAN_TRADES.get(1);
		VillagerTrades.ItemListing[] list2 = ECTrades.NETHER_LAMBMAN_TRADES.get(2);
		VillagerTrades.ItemListing[] list3 = ECTrades.NETHER_LAMBMAN_TRADES.get(3);
