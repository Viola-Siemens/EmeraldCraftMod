...
public class MineralTableMenu extends AbstractContainerMenu {
    ...
    public MineralTableMenu(int id, Inventory inventory, Container container, ContainerData data) {
        super(ECContainerTypes.MINERAL_TABLE_MENU, id);
    ...
    static class IngredientSlot extends Slot {
        ...
        @Override
        public boolean mayPlace(ItemStack itemStack) {
            return this.menu.level.getRecipeManager().getRecipeFor(ECRecipes.MINERAL_TABLE_TYPE, new SimpleContainer(itemStack), menu.level).isPresent();
        }
