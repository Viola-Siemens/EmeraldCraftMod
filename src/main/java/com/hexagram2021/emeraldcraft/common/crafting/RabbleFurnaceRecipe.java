...
public record RabbleFurnaceRecipe(ResourceLocation id, String group, String category, Ingredient ingredient,
                                  Ingredient mix1, Ingredient mix2,
                                  ItemStack result, float experience,
                                  int rabblingTime) implements Recipe<Container>, IPartialMatchRecipe<Container> {
    ...
    public RecipeSerializer<?> getSerializer() {
        return ECRecipeSerializer.RABBLE_FURNACE_SERIALIZER;
    }
    ...
    public RecipeType<?> getType() {
        return ECRecipes.RABBLE_FURNACE_TYPE;
    }
}
