...
public record CookedDumplingCookstoveRecipe(ResourceLocation id, FluidStack fluidStack, Ingredient container,
    ...
    public CookedDumplingCookstoveRecipeSerializer<CookedDumplingCookstoveRecipe> getSerializer() {
        return ECRecipeSerializer.COOKED_DUMPLING_COOKSTOVE_SERIALIZER;
    }

    @Override
    public RecipeType<CookedDumplingCookstoveRecipe> getType() {
        return ECRecipes.COOKED_DUMPLING_COOKSTOVE_TYPE;
    }
}
