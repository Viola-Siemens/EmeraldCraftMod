...
public class GlassKilnRecipe extends AbstractCookingRecipe {
    ...
    public GlassKilnRecipe(ResourceLocation id, String group, String category, Ingredient ingredient,
        ...
        super(ECRecipes.GLASS_KILN_TYPE, id, group, CookingBookCategory.MISC, ingredient, result, experience, cookingTime);
        this.category = category;
    }

    @Override
    public RecipeSerializer<?> getSerializer() {
        return ECRecipeSerializer.GLASS_KILN_SERIALIZER;
    }
