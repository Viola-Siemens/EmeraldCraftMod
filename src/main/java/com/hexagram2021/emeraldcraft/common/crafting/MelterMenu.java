...
public class MelterMenu extends Container {
	...
	private final IInventory melter;
	private final IIntArray melterData;
	private final Slot ingredientSlot;
	private final Slot resultInputSlot;
	protected final World level;

	public MelterMenu(int id, PlayerInventory inventory) {
		this(id, inventory, new Inventory(SLOT_COUNT), new IntArray(DATA_COUNT));
	}

	public MelterMenu(int id, PlayerInventory inventory, IInventory container, IIntArray data) {
	...
	static class IngredientSlot extends Slot {
		...
		public IngredientSlot(MelterMenu menu, IInventory container, int slot, int x, int y) {
		...
		@Override
		public boolean mayPlace(@Nonnull ItemStack itemStack) {
			return menu.level.getRecipeManager().getRecipeFor(ECRecipes.MELTER_TYPE, new Inventory(itemStack), menu.level).isPresent();
		}
	...
	static class MelterFuelSlot extends Slot {
		...
		public MelterFuelSlot(IInventory container, int slot, int x, int y) {
			super(container, slot, x, y);
		}
