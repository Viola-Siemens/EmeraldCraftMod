...
public class JEIHelper implements IModPlugin {
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		registration.addRecipes(new ArrayList<>(MelterRecipe.recipeList.values()), MelterRecipeCategory.UID);
		registration.addRecipes(new ArrayList<>(IceMakerRecipe.recipeList.values()), IceMakerRecipeCategory.UID);
	}
	...
	public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
		...
		registration.addRecipeCatalyst(new ItemStack(ECBlocks.WorkStation.MELTER), MelterRecipeCategory.UID);
