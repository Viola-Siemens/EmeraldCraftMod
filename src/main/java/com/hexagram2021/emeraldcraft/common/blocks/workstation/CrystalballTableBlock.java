...
public class CrystalballTableBlock extends Block {
    ...
    public static final Properties PROPERTIES = Block.Properties.of().mapColor(MapColor.COLOR_PURPLE).sound(SoundType.AMETHYST).strength(3.5F).randomTicks().lightLevel((bs) -> 7);
