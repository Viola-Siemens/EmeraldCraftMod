...
public class ECStructureSets {
	public static final StructureSet SET_SHELTER = new StructureSet(
	...
	public static final StructureSet SET_ENTRENCHMENT = new StructureSet(
	...
	public static void init() {
		Registry.register(BuiltinRegistries.STRUCTURE_SETS, new ResourceLocation(MODID, "shelter"), SET_SHELTER);
		Registry.register(BuiltinRegistries.STRUCTURE_SETS, new ResourceLocation(MODID, "nether_warfield"), SET_NETHER_WARFIELD);
		Registry.register(BuiltinRegistries.STRUCTURE_SETS, new ResourceLocation(MODID, "entrenchment"), SET_ENTRENCHMENT);
