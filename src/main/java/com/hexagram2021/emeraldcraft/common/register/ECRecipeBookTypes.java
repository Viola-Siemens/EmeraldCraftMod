...
public class ECRecipeBookTypes {
	...
	public static void init(RegisterRecipeBookCategoriesEvent event) {
		event.registerBookCategories(GLASS_KILN, List.of(GLASS_KILN_SEARCH, GLASS_KILN_SAND, GLASS_KILN_CLAY, GLASS_KILN_TERRACOTTA));
		event.registerAggregateCategory(GLASS_KILN_SEARCH, List.of(GLASS_KILN_SAND, GLASS_KILN_CLAY, GLASS_KILN_TERRACOTTA));
		event.registerRecipeCategoryFinder(ECRecipes.GLASS_KILN_TYPE, (recipe) -> {
