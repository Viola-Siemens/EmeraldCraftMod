...
public class ECBrewingRecipes {
	...
	private static void addFullRecipe(Potion input, Potion input_longer, Potion input_stronger, IItemProvider add, Potion origin, Potion longer, Potion stronger) {
	...
	@SuppressWarnings("SameParameterValue")
	private static void addFullRecipeWithoutStronger(Potion input, Potion input_longer, IItemProvider add, Potion origin, Potion longer) {
		addRecipe(input, add, origin);
		if(input_longer != null) {
			addRecipe(input_longer, add, longer);
		}
	...
	@SuppressWarnings("SameParameterValue")
	private static void addFullRecipeWithoutLonger(Potion input, Potion input_stronger, IItemProvider add, Potion origin, Potion stronger) {
		addRecipe(input, add, origin);
		if(input_stronger != null) {
			addRecipe(input_stronger, add, stronger);
		}
	...
	private static void addRecipe(Potion input, IItemProvider add, Potion output) {
	...
	private static final class ECBrewingRecipe extends BrewingRecipe {
		public ECBrewingRecipe(ItemStack input, IItemProvider add, ItemStack output) {
