...
public class ECItemTags {
    ...
    public static final TagKey<Item> MINCE = create("c", "mince");
    public static final TagKey<Item> EGGS = create("c", "eggs");
    public static final TagKey<Item> MUSHROOMS = create("c", "mushrooms");
    public static final TagKey<Item> WHEAT_DOUGH = create("c", "dough/wheat");
