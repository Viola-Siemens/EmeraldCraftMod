...
public class ECFeatures {
	...
	public static void init(RegistryEvent.Register<Feature<?>> event) {
		RegistryHelper.register(event, new ResourceLocation(MODID, "zombie_villager_room"), ZOMBIE_VILLAGER_ROOM);
		RegistryHelper.register(event, new ResourceLocation(MODID, "volcanic_caves_lava_pool"), VOLCANIC_CAVES_LAVA_POOL);
		RegistryHelper.register(event, new ResourceLocation(MODID, "vine_growth"), VINE_GROWTH);
	}
}
