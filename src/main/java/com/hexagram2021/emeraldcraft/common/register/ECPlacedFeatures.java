...
public class ECPlacedFeatures {
	...
	public static final Holder<PlacedFeature> FLOWER_HIGAN_BANA = register(
	...
	public static final Holder<PlacedFeature> TREES_PALM = register(
	...
	public static final Holder<PlacedFeature> TREES_PEACH = register(
	...
	public static final Holder<PlacedFeature> PURPURACEUS_FUNGI = register(
	...
	public static final Holder<PlacedFeature> PURPURACEUS_SWAMP_VEGETATION = register(
	...
	public static final Holder<PlacedFeature> PURPURACEUS_SWAMP_DELTA = register(
			"purpuraceus_swamp_delta", ECConfiguredFeatures.SpecialFeatures.PURPURACEUS_SWAMP_DELTA, List.of(
					CountOnEveryLayerPlacement.of(3), BiomeFilter.biome()
			)
	);
	public static final Holder<PlacedFeature> PURPURACEUS_SWAMP_LAVA_DELTA = register(
